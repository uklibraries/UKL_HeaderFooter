...
const headerStrings = {
	...
	ukltophdr_sitehdr:
		'<div id="uklsitelvl"><div class="ukl-ext-clamp"><header id="MainHeader" class="global-header "><div class="slab"><div class="slab__wrapper"><div class="global-header"><div class="global-header-layout"><div id="gethome"></div><span id="gethdrw"></span> <div class="nav-links"><div class="link" id="link1"><div id="getlink1"></div></div><div class="link" id="link2"><div id="getlink2"></div></div><div class="link" id="link3"><div id="getlink3"></div></div><div class="link" id="link4"><div id="getlink4"></div></div></div><div class="utility-links"><div id="springsrch"><form action="https://libguides.uky.edu/srch.php" role="search"><label id="springsrchLabel" for="searchTerm"><input type="text" id="searchTerm" name="q" placeholder="Search our Guides">&nbsp;</label><button type="submit" id="springbtn">Search</button></form></div><div class="link" id="link5"><div id="getlink5"></div></div><div class="link" id="link6"><div id="getlink6"></div></div></div></div></div></div></div></header></div>',
	ukltophdr_low_alert:
