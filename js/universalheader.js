...
const headerStrings = {
	...
	ukltophdr_top_alert:
		'<div id="top-alert" class="banner-alert"><div class="ukl-slab"><div class="ukl-slab__wrapper"><span class="ukl-icon-label"><span class="ic ic--alert" aria-hidden="true"></span><span id="tltalert"></span></span><div class="ukl-message"><p id="msgalert"></p><p>More at&nbsp;<a href="https://www.uky.edu/alert" id="ukalertlink" title="www.uky.edu/alert">www.uky.edu/alert</a></p><p>&nbsp;</p></div></div></div></div>',
	ukltophdr_univlvl:
	...
	ukltophdr_sitehdr:
		'<div id="uklsitelvl"><div class="ukl-ext-clamp"><header id="MainHeader" class="ukl-global-header "><div class="ukl-slab"><div class="ukl-slab__wrapper"><div class="ukl-global-header"><div class="ukl-global-header-layout"><div id="ukl-gethome"></div><span id="ukl-gethdrw"></span> <div class="ukl-nav-links"><div class="ukl-link" id="link1"><div id="ukl-getlink1"></div></div><div class="ukl-link" id="link2"><div id="ukl-getlink2"></div></div><div class="ukl-link" id="link3"><div id="ukl-getlink3"></div></div><div class="ukl-link" id="link4"><div id="ukl-getlink4"></div></div></div><div class="ukl-utility-links"><div id="springsrch"><form action="https://libguides.uky.edu/srch.php" role="search"><label id="springsrchLabel" for="searchTerm"><input type="text" id="searchTerm" name="q" placeholder="Search our Guides">&nbsp;</label><button type="submit" id="springbtn">Search</button></form></div><div class="ukl-link" id="link5"><div id="ukl-getlink5"></div></div><div class="ukl-link" id="link6"><div id="ukl-getlink6"></div></div></div></div></div></div></div></header></div>',
	ukltophdr_low_alert:
