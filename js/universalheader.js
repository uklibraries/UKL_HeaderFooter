...
var hdr = {};
var bases = ["home", "link1", "link2", "link3", "link4", "link5", "link6"];
...
if (typeof document.getElementsByName("hdr.alert.include")[0] != "undefined") {
...
function toggleMobile() {
	...
	window.addEventListener("resize", () => {
		...
		if (window.innerWidth > 768 && style == "none") {
			...
			document.getElementById("menu_button_more")
		) {
...
window.addEventListener("load", function () {
	if (hdr_simple == 0) {
		...
		if (DangerMsgToggle == "on") {
			...
			document.getElementById("ukalertlink").style.color =
