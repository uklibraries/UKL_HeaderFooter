...
function createLogoHeaderWithMobileButton(
	...
	mobile_menu_button.classList.add("ukl-menu-button-more", "ukl-menu-button");
  	...
  	mobile_menu_button.type = "button";
  	mobile_menu_button.setAttribute("aria-label", "More menu");
  	mobile_menu_button.setAttribute("aria-expanded", "false");
  	mobile_menu_button.setAttribute("aria-controls", "ukl-more-menu");
